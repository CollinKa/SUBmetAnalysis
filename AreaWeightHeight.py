...
for fileName in range(10):
    ...
    if not file or file.IsZombie():
        ...
        for key in keys:
            ...
            for subKey in keyINChFolder:
                ...
                if SubName.startswith("pul_"):
                    ...
                    HeightArea = ROOT.TH2F(f"HeightArea{SubName}", f"height vs Area {SubName}; height; area", 50, 0, 4000, 1000, 0, 2000000)
        ...
        # Open the ROOT file
        output_file = ROOT.TFile(f"board{fileName}_Height_Area_Width.root", "RECREATE")
